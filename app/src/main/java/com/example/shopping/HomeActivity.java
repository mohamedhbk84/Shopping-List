...
import com.example.shopping.model.Data;
  ...
  RecyclerView recyclerView;
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public void setAmmount(int ammount){
            ...
            TextView mAmount=myview.findViewById(R.id.ammount);
...
//        final EditText amount = dialog.findViewById(R.id.edt_Amount);
...
//               String mAmount = amount.getText().toString().trim();
//
//               int ammunt =  Integer.parseInt(mAmount);
//
//             if (TextUtils.isEmpty(mType)){
//                 type.setError("Required Field ...");
//                 return;
...
//                String date= DateFormat.getDateInstance().format(new Date());
//
//                Data data=new Data(mType,ammunt,mNote,date,id);
//
//                mDatabase.child(id).setValue(data);
//
...
//
//        public  void setAmmount(int ammount){
//            TextView mAmmoint = myview.findViewById(R.id.ammount);
//            String stam = String.valueOf(ammount);
//            mAmmoint.setText(stam);
//        }
//    }
//
//    public void updateData(){
